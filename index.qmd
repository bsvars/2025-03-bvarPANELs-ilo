...
### Structural Vector Autoregressions {style="color:#1A003F;"}

### Identification of Structural VARs {style="color:#1A003F;"}

### Dynamic Causal Effects {style="color:#1A003F;"}

### Bayesian Estimation {style="color:#1A003F;"}

### Monetary Policy Analysis Using the  [bsvars](https://cran.r-project.org/package=bsvars) Package {style="color:#1A003F;"}
...
### Lecture Slides [as a Website](https://bsvars.github.io/2024-10-be24-bsvars) {style="color:#1A003F;"}
...
### GitHub [repo](https://github.com/bsvars/2024-10-be24-bsvars) to reproduce the slides and results{style="color:#1A003F;"}
